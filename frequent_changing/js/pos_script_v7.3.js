(function ($) {
      ...
      function call_print_invoice(order_info, sale_id) {
        ...
        invoice_print+= `<!doctype html>
                ...
                <table style="width:100%">
                  <tr>
                        <td style="text-align:left">Server `+associate_user_name+`</td>
        ...
        if(Number(order.sub_total_discount_amount)){
            invoice_print+=`<tr>
                                        <th  class="text_left">`+inv_discount+`
                                           
                                        </th>
                                        <th class="text-right">
                                            `+getAmount(order.sub_total_discount_amount)+`
                                        </th>
                                        </tr>`;
        }
 ...
 invoice_print+= ` </table>
        ...
        invoice_print+= ` <tr>
                                        <th  class="text_left"><h3><b>Total</b></h3>
 ...
 invoice_print+= ` </table>
              ...
              if(is_active_table){
                  ...
                  if(booked_id){
                      if(this_active==1){
                          ...
                          get_details_of_a_particular_order(order_number,booked_id);
                          setTimeout(function () {
        ...
        function (e) {
          if (
            ...
            let sale_no = $(
              ...
              .find(".running_order_order_number").text();
                  ...
                  if (total_items_in_cart > 0) {
                      swal(
                          ...
                          function () {
                              ...
                              get_details_of_a_particular_order(running_order_order_number,sale_id);
                              setTimeout(function () {
    ...
    $(document).on("click", "#print_kot_modal", function (e) {
        ...
        if(checkInternetConnection()){
          ...
          get_all_information_from_indexeddb_kot_print(sale_id).then(function(data){
              if(data.order !== null) {
    ...
    function get_details_of_a_particular_order(sale_no,sale_id) {
                            ...
                            if(status==false  || is_self_order_tmp==1){
                                if (total_items_in_cart > 0) {
                                    swal(
                                        ...
                                        function () {
                                            $(".order_holder").empty();
                                            get_details_of_a_particular_order(sale_no,sale_id);
                                            $("#update_sale_id").val(sale_id);
                                            this_action.parent()
                                                .parent()
                                                .parent()
