                        ...
                        <div class="col-sm-12 mb-2 col-md-6">
                            <div class="form-group">
                                <div class="form-label-action">
                                    ...
                                    <a data-file_path="<?php echo base_url()?>uploads/common_menu_page/<?php echo isset($common_menu_page->common_menu_page_banner) && $common_menu_page->common_menu_page_banner ? $common_menu_page->common_menu_page_banner : ''; ?>"  data-id="1" class="btn bg-blue-btn show_preview" href="#"><?php echo lang('show'); ?></a>
                                </div>
                                <input type="file" id="logo" accept="image/*" name="common_menu_page_banner" class="form-control">
                            </div>
