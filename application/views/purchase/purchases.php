                                 ...
                                 <td class="ir_txt_center">
                                     <div class="btn-group  actionDropDownBtn">
                                         ...
                                         <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton1" role="menu">
                                             ...
                                             <li data-access="view_details-106" class="menu_assign_class"><a
                                                     href="<?php echo base_url() ?>Purchase/barcode/<?php echo escape_output($this->custom->encrypt_decrypt($prchs->id, 'encrypt')); ?>"><i
                                                         class="fa fa-barcode tiny-icon"></i><?php echo lang('barcode'); ?></a>
                                             </li>
