...
<head>
    ...
    body {
      ...
      background-image: url('<?= base_url('uploads/login_background.jpeg') ?>');


      /* Make the background cover the entire page */
      background-size: cover;

      /* Ensure the image stays fixed during scrolling */
    ...
    <div class="row">
        ...
        <div class="container">
            ...
            <div class="card" style="background: none !important;>
                ...
                ?>
                <h1 class="title" style="font-size: 67px;"><?php echo lang('login'); ?></h1>
