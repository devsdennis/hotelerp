                            ...
                            <tr style="background-color: <?php echo isset($spns->payment_clear) && $spns->payment_clear=="No"?'#af1f1f29':''?>">
                                ...
                                <td class="ir_txt_center">
                                    <div class="btn-group  actionDropDownBtn">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right dropdown_custom" aria-labelledby="dropdownMenuButton1" role="menu">
                                            <li><a
                                            ...
                                            <li><a
                                                        href="<?php echo base_url() ?>Authentication/redirectUrl/<?php echo escape_output($this->custom->encrypt_decrypt($spns->id, 'encrypt')); ?>"><i
                                                            class="fa fa-sign-in tiny-icon"></i><?php echo lang('login_as_company'); ?></a>
                                            </li>
                                            <li><a
                                                        href="<?php echo base_url() ?>Service/customerManualPayment/<?php echo escape_output($this->custom->encrypt_decrypt($spns->id, 'encrypt')); ?>"><i
                                                            class="fa fa-send tiny-icon"></i><?php echo lang('send_onine_payment_link'); ?></a>
                                            </li>
                                            <li>
                                                <?php
