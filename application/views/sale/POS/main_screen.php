...
<div class="cus_pos_modal cus_pos_modal_self_online_sale_modal" id="customModalSelfOnlineOrder">
    ...
    <aside id="pos__sidebar">
        <div class="brand__logo" style="text-align:center">
            <img style="width:20%"  src="<?php echo escape_output($system_logo); ?>">
        </div>
        <ul class="pos__menu__list scrollbar-macosx">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li data-access="view-360" class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/commissionReport"><i class="fa fa-angle-double-right"></i> <?php echo lang('commissionReport'); ?></a></li>
                </ul>
            </li>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>frequent_changing/js/pos_script_v7.3.js?v=1.1"></script>
