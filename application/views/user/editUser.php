        ...
        <div class="box-wrapper">
            ...
            <div class="table-box">
                ...
                <div class="box-body">
                    ...
                    <div class="col-sm-12 mb-2 col-md-3">
                        <div class="form-group">
                            <label><?php echo lang('sale_commission'); ?> <small>(Keep flat amount, system will consider as percentage)</small> </label>
                            <input tabindex="3" type="text" name="sale_commission" class="form-control integerchk"
                                placeholder="<?php echo lang('sale_commission'); ?>"
                                value="<?php echo escape_output($user_details->sale_commission) ?>">
                        </div>
                        <?php if (form_error('sale_commission')) { ?>
                        <div class="callout callout-danger my-2">
                            <span class="error_paragraph"><?php echo form_error('sale_commission'); ?></span>
                        </div>
                        <?php } ?>
                        </div>
