                    ...
                    <ul class="sidebar-menu ps ps--active-x ps--active-y tree" data-widget="tree">
                        ...
                        <li class="treeview menu__cidirp_12irp_12irp_15">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li data-access="view-360" class="menu_assign_class" data-menu__cid="irp_15"><a href="<?php echo base_url()?>Report/commissionReport"><?php echo lang('commissionReport'); ?></a></li>
                            </ul>
                        </li>
