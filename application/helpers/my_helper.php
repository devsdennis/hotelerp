...
function getFoodMenuForMenuPage() {
    $CI = & get_instance();
    $ig_information = $CI->db->query("SELECT `id`, `name`, `code`, `category_id`, `description`, `sale_price`, `photo`,parent_id,product_type,alternative_name, `tax_information`, `tax_string` FROM tbl_food_menus where `show_online` = 'Yes' and `del_status`='Live'")->result();
    return $ig_information;
}
